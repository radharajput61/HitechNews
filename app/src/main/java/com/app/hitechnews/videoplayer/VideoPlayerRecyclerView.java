...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        String mediaUrl = mediaObjects.get(targetPosition).getVideoLink();
        String thumbUrl = mediaObjects.get(targetPosition).getThumbnail();
        Picasso.with(context).load(thumbUrl).placeholder(R.drawable.logo).into(thumbnail);
        if (mediaUrl != null) {
    ...
    private void animateVolumeControl(){
        if(volumeControl != null){
            ...
            if(volumeState == VolumeState.OFF){
                requestManager.load(R.drawable.ic_valume_off_gray)
                        .into(volumeControl);
            }
            else if(volumeState == VolumeState.ON){
