...
public class DynamicHome extends Fragment {
    ...
    VideoItem videoItem;
    public static DynamicHome newInstance() {
        return new DynamicHome();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_dynamic_home, container, false);
...
//                            videoItems.add(new VideoItem(PostId,Title,Description,Location,PostDate,PostRelTo,TotalComment,TotalLike,TotalView,"http://abdekhegabharat.sigmasoftwares.co"+VideoLink,FollowerId,PostedBy,PostedImg,"1"));
                            ...
                            if(isAvail)
                            {
                                videoItems.add(new VideoItem(PostId,Title,Description,Location,PostDate,PostRelTo,TotalComment,TotalLike,TotalView,""+VideoLink,Thumbnail,FollowerId,PostedBy,PostedImg,"1",""));
                                Resources.MEDIA_OBJECTS = new VideoItem[]{
                                        new VideoItem(PostId, Title, Description, Location, PostDate, PostRelTo, TotalComment, TotalLike, TotalView, "" + VideoLink,Thumbnail, FollowerId, PostedBy, PostedImg, "1","")
                                };
                            }else{
                                videoItems.add(new VideoItem(PostId,Title,Description,Location,PostDate,PostRelTo,TotalComment,TotalLike,TotalView,""+VideoLink,Thumbnail,FollowerId,PostedBy,PostedImg,"0",""));
                                Resources.MEDIA_OBJECTS = new VideoItem[]{
                                        new VideoItem(PostId, Title, Description, Location, PostDate, PostRelTo, TotalComment, TotalLike, TotalView, "" + VideoLink,Thumbnail, FollowerId, PostedBy, PostedImg, "0","")
                                };
                            }
                        }
