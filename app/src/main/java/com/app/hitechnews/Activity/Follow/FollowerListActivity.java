...
public class FollowerListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        follower_recyclerview=findViewById(R.id.follower_recyclerview);
        follower_recyclerview.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.VERTICAL,false));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(array.length()>0)
                    {
                        ...
                        follower_recyclerview.setAdapter(followerAdapter);
                    }else{
