...
public class ProfileFragment extends Fragment {
    ...
    String UserId;
    TextView logout,tvName,tvEmail,tvAbout,tvFollowrs,tvFollowing,tvGroup,tvMobileAndGender,tvEdit,tvChangeProfilePic;
...
//        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_wish_list1));
//        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_contact));
//        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_video_camera1));
        ...
        tvFollowrs=root.findViewById(R.id.tvFollowrs);
        tvFollowing=root.findViewById(R.id.tvFollowing);
        ...
        llFollower=root.findViewById(R.id.llFollower);
        llFollowing=root.findViewById(R.id.llFollowing);
                ...
                try {
                    ...
                    if(status)
                    {
                        ...
                        if(!Name.equalsIgnoreCase(""))
                            ...
                            tvName.setText("Name here");

                        if(!Email.equalsIgnoreCase(""))
                            tvEmail.setText(Email);
                        else
                            tvEmail.setText("Email here");

                        if(!MobileNo.equalsIgnoreCase(""))
                            tvMobileAndGender.setText(MobileNo+" | Gender - "+Gender);
                        else
                            tvMobileAndGender.setText("");
                        ...
                        if(!TotalFollower.equalsIgnoreCase(""))
                            tvFollowrs.setText(TotalFollower);
                        else
                            tvFollowrs.setText("0");

                        if(!TotalFollowing.equalsIgnoreCase(""))
                            tvFollowing.setText(TotalFollowing);
                        else
                            tvFollowing.setText("0");

                        if(!TotalGroup.equalsIgnoreCase(""))
                            tvGroup.setText(TotalGroup);
                        else
                            tvGroup.setText("0");
