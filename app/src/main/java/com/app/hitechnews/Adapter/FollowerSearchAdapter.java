...
public class FollowerSearchAdapter extends RecyclerView.Adapter<FollowerSearchAdapter.RRViewHolder> {

    private Context context;
    private List<FollowerModel> arrayList;
    int i=0;

    public FollowerSearchAdapter(Context context, List<FollowerModel> arrayList) {
    ...
    public RRViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.follower_hori_list_item, parent, false);
