...
//            HomeFragment homeFragment=new HomeFragment();
            DynamicHome homeFragment=new DynamicHome();
...
//                break;
    ...
    public void showchooser() {
        ...
        View mView = LayoutInflater.from(MainActivity.this).inflate(R.layout.layout_selection, null);
...
//                bottomSheetBehavior.setState(BottomSheetBehavior.STATE_EXPANDED);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_VIDEO_CAPTURE && resultCode == RESULT_OK) {
            ...
            String imagePath=getPathFromUri(MainActivity.this,videoUri);
...
//            }
        ...
        if (requestCode == 100 && resultCode == RESULT_OK) {
            videoUri = intent.getData();
            startActivity(new Intent(MainActivity.this, PrepairVideoForUploadActivity.class));
        }
    }
